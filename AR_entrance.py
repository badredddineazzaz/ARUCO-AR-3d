...
if __name__ == "__main__":
    ...
    cam_matrix = np.array([
        [1.01937187e+03, 0.00000000e+00, 6.18709848e+02],
        [0.00000000e+00, 1.02421380e+03, 3.27280578e+02],
        [0.00000000e+00, 0.00000000e+00, 1.00000000e+00],
        ])

    dist_coeff = np.array([0.49921041, -2.2731793, -0.01392174, 0.01677649, 3.99742617])    
    ar_instance = AR_render(cam_matrix, dist_coeff, './Models/lungLast/lung.obj', model_scale = 0.03)
    ar_instance.run() 